...
int main(int argc, char **argv)
{
    ...
    caffemodel_file.push_back("/usr/local/src/robot/bvlc_googlenet.caffemodel");
...
//    prototxt_file_caffe.push_back("/usr/local/src/robot/caffeVSgie_feat_extraction/networks/bvlc_googlenet_val_cutpool5.prototxt");
    ...
    out_dir_caffe.push_back("/usr/local/src/robot/out/GIEvsCaffe/Caffe/caffenet/images2");
    out_dir_caffe.push_back("/usr/local/src/robot/out/GIEvsCaffe/Caffe/googlenet/images2");
